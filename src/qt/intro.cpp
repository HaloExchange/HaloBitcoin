...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/halobitcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Halo Bitcoin Core"),
     ...
     * override -datadir in the halobitcoin.conf file in the default data directory
     * (to be consistent with halobitcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
