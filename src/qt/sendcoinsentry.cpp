    ...
    model(0)
{
    ...
    // normal halobitcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying halobitcoin address(es)
    ui->payTo_is->setFont(GUIUtil::halobitcoinAddressFont());
...
void SendCoinsEntry::clear()
{
    ...
    // update the display unit, to not use the default ("HBTC")
    updateDisplayUnit();
}
