...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Halo Bitcoin Core halobitcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  halobitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded halobitcoin transaction") + "\n" +
              "  halobitcoin-tx [options] -create [commands]   " + _("Create hex-encoded halobitcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded halobitcoin transaction
