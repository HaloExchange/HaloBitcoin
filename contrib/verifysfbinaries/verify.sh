...
###   This script attempts to download the signature file SHA256SUMS.asc from halobitcoin.org
...
WORKINGDIR="/tmp/halobitcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://halobitcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://halobitcoin.org/bin/"
VERSIONPREFIX="halobitcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'halobitcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[halobitcoin-]<version>-[rc[0-9]] (example: halobitcoin-0.9.2-rc1)"
   echo "wget output:"
