...
allowing somebody to distribute a Bitcoin-Qt.app or halobitcoin-qt-setup.exe with a valid
...
that the halobitcoin-qt.exe file inside the installer had not been tampered with.
