The following is a list of assets used in the halobitcoin source and their proper attribution.
...
* License: MIT
* Site: [https://halobitcointalk.org/index.php?topic=15276.0](https://halobitcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original halobitcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/halobitcoin.icns, src/qt/res/src/halobitcoin.svg,
	src/qt/res/src/halobitcoin.ico, src/qt/res/src/halobitcoin.png,
	src/qt/res/src/halobitcoin_testnet.png, docs/halobitcoin_logo_doxygen.png,
